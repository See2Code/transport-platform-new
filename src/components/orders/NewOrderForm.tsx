                                    ...
                                    {place.goods?.map((item, goodsIndex) => (
                                        ...
                                        >
                                            ...
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid item xs={6} sm={3}><TextField label="Množstvo *" type="number" value={item.quantity} onChange={handleGoodsChange('loading', index, goodsIndex, 'quantity')} required inputProps={{step: 0.01}} fullWidth/></Grid>
                                     ...
                                     {place.goods?.map((item, goodsIndex) => (
                                         ...
                                         >
                                             ...
                                             <Grid container spacing={2}>
                                                 ...
                                                 <Grid item xs={6} sm={3}><TextField label="Množstvo *" type="number" value={item.quantity} onChange={handleGoodsChange('unloading', index, goodsIndex, 'quantity')} required inputProps={{step: 0.01}} fullWidth/></Grid>
